...
public class ClienteRequest {
    @NotBlank(message = "O no me é obrigatório")
    @Size(min = 5, max = 150, message = "O nome deve ter ter entre 3 e 150 caracteres")
    private String nome;
    @Min(value = 18, message = "O cliente deve ter no mínimo 18 anos")
    private int idade;
    @Email(message = "Email fora fo formato correto")
